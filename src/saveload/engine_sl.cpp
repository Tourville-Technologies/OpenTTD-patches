...
static const SaveLoad _engine_desc[] = {
	 ...
	 SLE_CONDVAR(Engine, preview_asked,       SLE_UINT16 | SLE_UINT32,                SLV_179, SLV_15_COMPANY),
	 SLE_CONDVAR(Engine, preview_asked,       SLE_UINT32,                SLV_15_COMPANY, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, preview_company,     SLE_UINT8,                 SLV_179, SL_MAX_VERSION),
	     SLE_VAR(Engine, preview_wait,        SLE_UINT8),
	 SLE_CONDVAR(Engine, company_avail,       SLE_FILE_U8  | SLE_UINT32,  SL_MIN_VERSION, SLV_104),
	 SLE_CONDVAR(Engine, company_avail,       SLE_UINT16 | SLE_UINT32,                SLV_104, SLV_15_COMPANY),
	 SLE_CONDVAR(Engine, company_avail,       SLE_UINT32,                SLV_15_COMPANY, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, company_hidden,      SLE_UINT16 | SLE_UINT32,                SLV_193, SLV_15_COMPANY),
	 SLE_CONDVAR(Engine, company_hidden,      SLE_UINT32,                SLV_15_COMPANY, SL_MAX_VERSION),
